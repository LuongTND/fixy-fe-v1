      ...
      <div className="space-y-5 animate-fade-in">
        ...
        <div className="bg-white rounded-3xl shadow-sm p-6 md:p-8 border border-[#E8E8E8]/60">
          <div className="flex items-center justify-between mb-6">
            ...
            <Link
              href="/wallet"
              className="text-primary font-bold text-[11px] hover:underline flex items-center gap-1 uppercase tracking-wider"
            >
              Tất cả
          ...
          <div className="space-y-4">
            ...
            {!walletLoading && recentTransactions.length === 0 && (
              <div className="rounded-2xl border border-dashed border-[#E8E8E8] p-10 text-center">
                ...
                <p className="text-xs font-bold text-[#818A91]">
            ...
            {!walletLoading &&
              recentTransactions.map((tx) => {
                ...
                return (
                  <div
                    key={tx.id || tx.createdDate || tx.createdAt}
                    className="flex items-center justify-between p-4 rounded-2xl border border-[#F8F8F8] bg-white hover:border-primary/20 hover:shadow-md transition-all group cursor-pointer"
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h4 className="font-bold text-[#1b1c1c] text-sm group-hover:text-primary transition-colors">
                    ...
                    <div className="text-right">
                      <p
                        className={`font-black text-sm md:text-base ${amount < 0 ? "text-[#EA4335]" : "text-[#39B54A]"}`}
                      >
                        {amount > 0 ? "+" : ""}
                      ...
                      <div className="mt-1 flex justify-end">
                        <p
                          className={`text-[9px] uppercase font-black tracking-widest px-2 py-0.5 rounded-md ${
                            getTransactionStatus(tx) === "Hoàn tất"
                              ? "bg-[#39B54A]/10 text-[#39B54A]"
                              : "bg-[#818A91]/10 text-[#818A91]"
                          }`}
                        >
