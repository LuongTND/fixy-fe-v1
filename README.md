...
Fixy là nền tảng trung gian (marketplace) kết nối thợ nghề với khách hàng có nhu cầu sử dụng dịch vụ sửa chữa và bảo trì. Hệ thống hoạt động theo mô hình ba bên: Nền tảng (Fixy) – Thợ nghề – Khách hàng.
...
- **Hệ sinh thái số**: Giúp thợ nghề tự do dễ dàng tiếp cận khách hàng và tăng thu nhập ổn định.
- **Kênh đặt lịch tiện lợi**: Cung cấp cho khách hàng một kênh đặt dịch vụ nhanh chóng, minh bạch và an toàn.
- **Vai trò trung gian**: Nền tảng Fixy đảm bảo chất lượng dịch vụ, xử lý thanh toán và hỗ trợ giải quyết tranh chấp.
- **Đánh giá & Uy tín**: Xây dựng hệ thống đánh giá, xếp hạng thợ nhằm nâng cao chất lượng dịch vụ liên tục.
...
| **Admin Panel**           | Quản trị viên Fixy                             | Giao diện quản trị nội bộ: duyệt thợ, quản lý danh mục, theo dõi giao dịch, báo cáo hệ thống. |
...
- **Mộc** – Nội thất gỗ
- **Sơn** – Sơn nhà, trần nhà
- **Dọn vệ sinh** – Tổng vệ sinh
- _Và các dịch vụ thủ công khác (mở rộng qua Admin)_
...
_Đây là ứng dụng dành riêng cho thợ nghề – những người cung cấp dịch vụ trên nền tảng Fixy._
...
_Đây là ứng dụng dành cho khách hàng – những người có nhu cầu sử dụng dịch vụ thợ nghề._
...
_Giao diện quản trị nội bộ của Fixy, truy cập qua web browser (Next.js)._
...
- **Backend Services (.NET Core)**:
  - _Auth Service_: Xác thực, phân quyền, quản lý token.
  - _User Service_: Quản lý hồ sơ thợ và khách hàng.
  - _Booking Service_: Xử lý đặt lịch, ghép thợ, trạng thái đơn.
  - _Payment Service_: Tích hợp cổng thanh toán, quản lý ví.
  - _Notification Service_: Push, SMS, email, in-app notification.
  - _Review Service_: Đánh giá, xếp hạng thợ.
  - _Chat Service_: Real-time messaging via SignalR.
